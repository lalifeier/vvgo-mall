module github.com/lalifeier/vvgo
...
require (
	...
	github.com/mattn/go-colorable v0.1.11 // indirect; indirect v1.18.0
	...
	gopkg.in/ini.v1 v1.63.2 // indirect; indirect v2.0.0-20190816093944-a6b53ec6cb22
)
