...
func (sc *StaffCreate) SetGender(i int8) *StaffCreate {
	sc.mutation.SetGender(i)
	return sc
}

// SetNillableGender sets the "gender" field if the given value is not nil.
func (sc *StaffCreate) SetNillableGender(i *int8) *StaffCreate {
	if i != nil {
		sc.SetGender(*i)
	}
	return sc
...
func (sc *StaffCreate) check() error {
	...
	if _, ok := sc.mutation.Gender(); !ok {
		return &ValidationError{Name: "gender", err: errors.New(`ent: missing required field "Staff.gender"`)}
	}
	if _, ok := sc.mutation.CreatedAt(); !ok {
