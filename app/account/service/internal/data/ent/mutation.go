...
func withAccountUserID(id uint32) accountuserOption {
...
func (m *AccountUserMutation) ClearUsername() {
	m.username = nil
	m.clearedFields[accountuser.FieldUsername] = struct{}{}
}

// UsernameCleared returns if the "username" field was cleared in this mutation.
func (m *AccountUserMutation) UsernameCleared() bool {
	_, ok := m.clearedFields[accountuser.FieldUsername]
	return ok
}
...
func (m *AccountUserMutation) ResetUsername() {
	m.username = nil
	delete(m.clearedFields, accountuser.FieldUsername)
}
...
func (m *AccountUserMutation) ClearPhone() {
	m.phone = nil
	m.clearedFields[accountuser.FieldPhone] = struct{}{}
}

// PhoneCleared returns if the "phone" field was cleared in this mutation.
func (m *AccountUserMutation) PhoneCleared() bool {
	_, ok := m.clearedFields[accountuser.FieldPhone]
	return ok
}
...
func (m *AccountUserMutation) ResetPhone() {
	m.phone = nil
	delete(m.clearedFields, accountuser.FieldPhone)
}
...
func (m *AccountUserMutation) ClearEmail() {
	m.email = nil
	m.clearedFields[accountuser.FieldEmail] = struct{}{}
}

// EmailCleared returns if the "email" field was cleared in this mutation.
func (m *AccountUserMutation) EmailCleared() bool {
	_, ok := m.clearedFields[accountuser.FieldEmail]
	return ok
}
...
func (m *AccountUserMutation) ResetEmail() {
	m.email = nil
	delete(m.clearedFields, accountuser.FieldEmail)
}
...
func (m *AccountUserMutation) ClearPassword() {
	m.password = nil
	m.clearedFields[accountuser.FieldPassword] = struct{}{}
}

// PasswordCleared returns if the "password" field was cleared in this mutation.
func (m *AccountUserMutation) PasswordCleared() bool {
	_, ok := m.clearedFields[accountuser.FieldPassword]
	return ok
}
...
func (m *AccountUserMutation) ResetPassword() {
	m.password = nil
	delete(m.clearedFields, accountuser.FieldPassword)
}
...
// WhereP appends storage-level predicates to the AccountUserMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *AccountUserMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.AccountUser, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
func (m *AccountUserMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(accountuser.FieldUsername) {
		fields = append(fields, accountuser.FieldUsername)
	}
	if m.FieldCleared(accountuser.FieldPhone) {
		fields = append(fields, accountuser.FieldPhone)
	}
	if m.FieldCleared(accountuser.FieldEmail) {
		fields = append(fields, accountuser.FieldEmail)
	}
	if m.FieldCleared(accountuser.FieldPassword) {
		fields = append(fields, accountuser.FieldPassword)
	}
	return fields
}
