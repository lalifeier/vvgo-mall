...
func NewGRPCServer(c *conf.Server, logger log.Logger, accountService *service.AccountService, accountUserService *service.AccountUserService) *grpc.Server {
	...
	v1.RegisterAccountUserServiceServer(srv, accountUserService)
