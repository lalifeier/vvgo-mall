...
import (
	...
	v1 "github.com/lalifeier/vvgo-mall/gen/api/go/taoke/interface/v1"
...
func NewHTTPServer(c *conf.Server, ac *conf.Auth, logger log.Logger, taoKeService *service.TaoKeService) *http.Server {
	...
	v1.RegisterTaoKeHTTPServer(srv, taoKeService)
	return srv
}
