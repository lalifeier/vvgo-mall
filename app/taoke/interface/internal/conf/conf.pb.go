...
type Data struct {
	...
	DaTaoKe  *Data_DaTaoKe  `protobuf:"bytes,3,opt,name=daTaoKe,proto3" json:"daTaoKe,omitempty"`
}
...
func (x *Data) GetDaTaoKe() *Data_DaTaoKe {
	if x != nil {
		return x.DaTaoKe
	}
	return nil
...
func (x *Data_DaTaoKe) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_DaTaoKe) ProtoMessage() {}

func (x *Data_DaTaoKe) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_DaTaoKe.ProtoReflect.Descriptor instead.
func (*Data_DaTaoKe) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{2, 2}
}

func (x *Data_DaTaoKe) GetAppKey() string {
	if x != nil {
		return x.AppKey
	}
	return ""
...
func (x *Data_DaTaoKe) GetAppSecret() string {
	if x != nil {
		return x.AppSecret
	}
	return ""
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x22, 0xbe, 0x04, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64, 0x61, 0x74,
	...
	0x0a, 0x07, 0x64, 0x61, 0x54, 0x61, 0x6f, 0x4b, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x18, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74,
	0x61, 0x2e, 0x44, 0x61, 0x54, 0x61, 0x6f, 0x4b, 0x65, 0x52, 0x07, 0x64, 0x61, 0x54, 0x61, 0x6f,
	0x4b, 0x65, 0x1a, 0x3a, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x12, 0x16,
	...
	0x52, 0x0c, 0x77, 0x72, 0x69, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x41,
	0x0a, 0x07, 0x44, 0x61, 0x54, 0x61, 0x6f, 0x4b, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x61, 0x70, 0x70,
	...
	0x69, 0x6e, 0x74, 0x22, 0x40, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x1f, 0x0a, 0x0b, 0x73,
	...
	0x70, 0x69, 0x4b, 0x65, 0x79, 0x42, 0x1e, 0x5a, 0x1c, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_DaTaoKe)(nil),        // 10: kratos.api.Data.DaTaoKe
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	10, // 8: kratos.api.Data.daTaoKe:type_name -> kratos.api.Data.DaTaoKe
