...
type AccountUser struct {
	...
	// 最后一次登录时间
	LastLoginAt int32 `json:"last_login_at,omitempty"`
...
func (*AccountUser) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case accountuser.FieldEmail, accountuser.FieldPhone, accountuser.FieldUsername, accountuser.FieldPassword, accountuser.FieldCreateIPAt, accountuser.FieldLastLoginIPAt:
	...
	for i := range columns {
		...
		case accountuser.FieldLastLoginAt:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				au.LastLoginAt = int32(value.Int64)
			}
		...
		case accountuser.FieldLoginTimes:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				au.LoginTimes = int32(value.Int64)
			}
