...
func (apq *AccountPlatformQuery) Unique(unique bool) *AccountPlatformQuery {
	apq.unique = &unique
	return apq
}
...
func (apq *AccountPlatformQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (apq *AccountPlatformQuery) FirstIDX(ctx context.Context) int64 {
...
func (apq *AccountPlatformQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (apq *AccountPlatformQuery) OnlyIDX(ctx context.Context) int64 {
...
func (apq *AccountPlatformQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (apq *AccountPlatformQuery) IDsX(ctx context.Context) []int64 {
	ids, err := apq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		Scan(ctx, &v)
//
func (apq *AccountPlatformQuery) Select(fields ...string) *AccountPlatformSelect {
